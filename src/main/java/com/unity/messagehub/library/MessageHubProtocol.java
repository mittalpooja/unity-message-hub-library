...
public class MessageHubProtocol {
	...
	private static final HashMap<String, Byte> map = new HashMap<String, Byte>();
	static 
	{
		map.put("getId", GET_ID_REQUEST);
		map.put("getList", GET_LIST_REQUEST);
		map.put("relay", RELAY_REQUEST);
	};
